...
void testApp::update(){
	...
	//switch between REVIEW MODE and LIVE MODE
...
void testApp::draw(){
	...
	ofCircle(leftHandPX*SCALE+RENDER_WIDTH,leftHandPY*SCALE+105,10); 
	ofCircle(rightHandPX*SCALE+RENDER_WIDTH,rightHandPY*SCALE+105,10);
	ofLine(headPositionX*SCALE+RENDER_WIDTH,headPositionY*SCALE+105,leftShoulderX*SCALE+RENDER_WIDTH, leftShoulderY*SCALE+105);
